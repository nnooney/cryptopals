// This is a modified version of the xls file xls/common/logging/log_lines.h
...
#ifndef CRYPTOPALS_UTIL_INTERNAL_LOGGING_LOG_LINES_H_
#define CRYPTOPALS_UTIL_INTERNAL_LOGGING_LOG_LINES_H_
...
#define LOG_LINES(SEVERITY, STRING)                                       \
  ::absl::logging::LogLines(LOGGING_INTERNAL_SEVERITY_##SEVERITY, STRING, \
                            __FILE__, __LINE__)
...
#define VLOG_LINES(LEVEL, STRING)                   \
  do {                                              \
    if (VLOG_IS_ON(LEVEL)) LOG_LINES(INFO, STRING); \
  } while (false)

#endif  // CRYPTOPALS_UTIL_INTERNAL_LOGGING_LOG_LINES_H_
