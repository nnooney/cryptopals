// This is a modified version of the xls file xls/common/logging/log_entry.h
...
#ifndef CRYPTOPALS_UTIL_INTERNAL_LOGGING_LOG_ENTRY_H_
#define CRYPTOPALS_UTIL_INTERNAL_LOGGING_LOG_ENTRY_H_
...
class LogEntry {
 ...
 private:
  ...
  friend class ::absl::logging_internal::LogMessage;
};

}  // namespace absl

#endif  // CRYPTOPALS_UTIL_INTERNAL_LOGGING_LOG_ENTRY_H_
