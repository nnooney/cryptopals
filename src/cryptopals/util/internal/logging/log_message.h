// This is a modified version of the xls file xls/common/logging/log_message.h
...
#ifndef CRYPTOPALS_UTIL_INTERNAL_LOGGING_LOG_MESSAGE_H_
#define CRYPTOPALS_UTIL_INTERNAL_LOGGING_LOG_MESSAGE_H_
...
// `LOG` macro is strongly discouraged.
class LogMessage {
 public:
  ...
  // also facilitate mutator methods on `CHECK` and `CHECK_EQ` by doing
  ...
  // Call `abort()` or similar to perform `LOG(FATAL)` crash.  Writes
...
#endif  // CRYPTOPALS_UTIL_INTERNAL_LOGGING_LOG_MESSAGE_H_
