...
// xls/common/logging/scoped_mock_log.h obtained from
...
#ifndef CRYPTOPALS_UTIL_INTERNAL_LOGGING_SCOPED_MOCK_LOG_H_
#define CRYPTOPALS_UTIL_INTERNAL_LOGGING_SCOPED_MOCK_LOG_H_
...
#endif  // CRYPTOPALS_UTIL_INTERNAL_LOGGING_SCOPED_MOCK_LOG_H_
