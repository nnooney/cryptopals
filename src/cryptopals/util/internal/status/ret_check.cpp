// This is a modified version of the xls file xls/common/status/ret_check.cc
...
#include "cryptopals/util/internal/status/ret_check.h"
...
absl::StatusBuilder RetCheckFailSlowPath(absl::SourceLocation location) {
  return absl::InternalErrorBuilder(location)
