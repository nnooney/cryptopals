// This is a modified version of the xls file xls/common/status/statusor.h
...
#ifndef CRYPTOPALS_UTIL_INTERNAL_STATUS_STATUSOR_H_
#define CRYPTOPALS_UTIL_INTERNAL_STATUS_STATUSOR_H_
...
#include "cryptopals/util/internal/status/statusor_internals.h"
...
class ABSL_MUST_USE_RESULT StatusOr
 ...
 public:
  ...
  StatusOr(const absl::StatusBuilder& builder);  // NOLINT
  StatusOr& operator=(const absl::StatusBuilder& builder);
  ...
  StatusOr(absl::StatusBuilder&& builder);  // NOLINT
  StatusOr& operator=(absl::StatusBuilder&& builder);
...
template <typename T>
StatusOr<T>::StatusOr(const absl::StatusBuilder& builder) : Base(builder) {}
...
template <typename T>
StatusOr<T>& StatusOr<T>::operator=(const absl::StatusBuilder& builder) {
...
template <typename T>
StatusOr<T>::StatusOr(absl::StatusBuilder&& builder)
...
template <typename T>
StatusOr<T>& StatusOr<T>::operator=(absl::StatusBuilder&& builder) {
...
#endif  // CRYPTOPALS_UTIL_INTERNAL_STATUS_STATUSOR_H_
