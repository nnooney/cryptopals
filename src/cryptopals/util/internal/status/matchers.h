// This is a modified version of the xls file xls/common/status/matchers.h
...
//
//   There are no EXPECT_NOT_OK/ASSERT_NOT_OK macros since they would
 ...
 public:
  ...
  bool MatchAndExplain(
    ...
    return common_impl_.MatchAndExplain(
        ::testing::status::internal_status::GetStatus(actual_value),
        result_listener);
  }
...
class MonoIsOkMatcherImpl : public ::testing::MatcherInterface<T> {
 public:
  ...
  bool MatchAndExplain(T actual_value,
    ...
    return testing::status::internal_status::GetStatus(actual_value).ok();
  }
};
...
#define ASSERT_OK_AND_ASSIGN(lhs, rexpr)                                     \
  ASSIGN_OR_RETURN(/* NOLINT(clang-diagnostic-shadow) */                     \
                   lhs, rexpr,                                               \
                   testing::status::internal_status::AddFatalFailure(#rexpr, \
                                                                     _))
