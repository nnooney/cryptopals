...
// xls/common/status/statusor_internals.h obtained from
...
#ifndef CRYPTOPALS_UTIL_INTERNAL_STATUSOR_INTERNALS_H_
#define CRYPTOPALS_UTIL_INTERNAL_STATUSOR_INTERNALS_H_
...
using IsDirectInitializationValid = absl::disjunction<
    ...
    absl::negation<absl::disjunction<
        ...
        std::is_same<absl::Status,
                     absl::remove_cv_t<absl::remove_reference_t<U>>>,
        std::is_same<absl::StatusBuilder,
                     absl::remove_cv_t<absl::remove_reference_t<U>>>,
...
class StatusOrData {
 ...
 public:
  ...
  explicit StatusOrData(const absl::StatusBuilder& builder) : status_(builder) {
    EnsureNotOk();
  }
  explicit StatusOrData(absl::StatusBuilder&& builder)
...
#endif  // CRYPTOPALS_UTIL_INTERNAL_STATUSOR_INTERNALS_H_
