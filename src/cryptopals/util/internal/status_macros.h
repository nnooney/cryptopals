...
// iree/base/internal/status_macros.h obtained from
...
#ifndef CRYPTOPALS_UTIL_INTERNAL_STATUS_MACROS_H_
#define CRYPTOPALS_UTIL_INTERNAL_STATUS_MACROS_H_
...
#endif  // CRYPTOPALS_UTIL_INTERNAL_STATUS_MACROS_H_
